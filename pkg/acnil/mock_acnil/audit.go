...
func (mr *MockAuditDatabaseMockRecorder) Append(ctx, entries interface{}) *gomock.Call {
...
func (mr *MockAuditDatabaseMockRecorder) List(ctx interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// List indicates an expected call of List.
func (mr *MockROGameDatabaseMockRecorder) List(ctx interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
